...
public class UserControllerTest {
    ...
    @Test
    public void getUsersByIdList() throws Exception {
        // given
        User user1 = new User(1L, "Hariharan");
        User user2 = new User(2L, "Fillipe");
        ...
        then(response.getContentAsString()).isEqualTo(jsonRequestUser.write(List.of(user1, user2))
                .getJson());
    }
}